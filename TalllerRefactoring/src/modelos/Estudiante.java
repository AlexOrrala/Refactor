...
public class Estudiante{
    ...
    public double CalcularNotaInicialyFinal(Paralelo p, double nexamen,double ndeberes, double nlecciones, double ntalleres, boolean inicial){
        ...
        if(inicial==true){
            p.getMateria().setNotaInicial(notaInicial);
        }else{
            p.getMateria().setNotaFinal(notaInicial);
        }
        return notaInicial;
    }
